/*! For license information please see main.10a43592.js.LICENSE.txt */
!(function () {
  var e = {
      888: function (e, n, t) {
        'use strict'
      ...
      463: function (e, n, t) {
              ...
              (function (e, n, t, r, l) {
                switch (n) {
                  ...
                  case 'gotpointercapture':
                    return (
                      (a = l.pointerId),
                      jn.set(a, Fn(jn.get(a) || null, e, n, t, r, l)),
                      !0
                    )
                }
                return !1
        ...
        function Wa(e, n, t, r) {
          ...
          'object' === typeof a && null !== a
            ? (l.context = Ca(a))
            : ((a = Ll(n) ? Ol : Pl.current), (l.context = Tl(e, a))),
        ...
        function vs(e, n) {
          ...
          if ((ka(), (Pi = t), (Ci.current = r), null !== Oi))
            throw Error(a(261))
        ...
        function ws(e) {
          ...
          do {
            ...
            if (((e = n.return), 0 === (32768 & n.flags))) {
              if (null !== (t = qu(t, n, Li))) return void (Oi = t)
            } else {
              if (null !== (t = Ku(t, n)))
                return (t.flags &= 32767), void (Oi = t)
              if (null === e) return (Ri = 6), void (Oi = null)
        ...
        function Cs(e, n, t) {
          ...
          null !== r && r.delete(n),
            ...
            zi === e &&
              (Ti & t) === t &&
              (4 === Ri ||
              (3 === Ri && (130023424 & Ti) === Ti && 500 > Ge() - Vi)
                ? ds(e, 0)
                : (Ii |= t)),
            rs(e, n)
        }
        ...
        function Rs(e, n, t, r, l, o) {
          ...
          if (((r = e), 'function' === typeof e)) Ls(e) && (u = 1)
            ...
            e: switch (e) {
              ...
              case O:
                return ((e = Ts(19, t, n, l)).elementType = O), (e.lanes = o), e
              case j:
                return Ds(t, l, o, n)
              default:
        ...
        xi = function (e, n, t) {
          ...
          switch (((n.lanes = 0), n.tag)) {
            ...
            case 3:
              e: {
                if ((Ou(n), null === e)) throw Error(a(387))
                ;(r = n.pendingProps),
  ...
  ;(t.n = function (e) {
    ...
    (function () {
      ...
      var o = {
        ...
        u = e.createContext && e.createContext(o),
        i = function () {
          return (
            (i =
              Object.assign ||
      ...
      function c(n) {
        return (
          n &&
          n.map(function (n, t) {
            return e.createElement(n.tag, i({ key: t }, n.attr), c(n.child))
          })
        )
      }
      function f(n) {
        return function (t) {
          return e.createElement(d, i({ attr: i({}, n.attr) }, t), c(n.child))
        }
      }
      function d(n) {
        var t = function (t) {
      ...
      var y,
          ...
          switch (n.type) {
            case 'ADD_EXPENSE':
              return g(
                g({}, e),
                {},
                { expenses: [].concat(m(e.expenses), [n.payload]) }
              )
            case 'DELETE_EXPENSE':
              return g(
                g({}, e),
        ...
        E = function (n) {
          var t = (0, e.useContext)(S).dispatch
          return (0, b.jsxs)('li', {
            className:
              ...
              (0, b.jsxs)('div', {
                children: [
                  ...
                  (0, b.jsx)(p, {
                    ...
                    size: '1.5em',
                    onClick: function () {
                      t({ type: 'DELETE_EXPENSE', payload: n.id })
                    },
                  }),
                ],
              }),
        ...
        C = function (n) {
          var t = (0, e.useContext)(S).expenses.filter(function (e) {
            return e.name.toLowerCase().includes(n.filter)
          })
          return (0, b.jsx)('ul', {
            className: 'list-group',
            children: t.map(function (e) {
              return (0,
              b.jsx)(E, { id: e.id, name: e.name, cost: e.cost }, e.id)
            }),
          })
        },
        _ = function (n) {
        ...
        N = function () {
          var n = a((0, e.useState)(!1), 2),
            ...
            c = i[1]
          return (0, b.jsx)('div', {
            className: 'alert alert-secondary text-center col-sm pb-2',
            children: (0, b.jsxs)('form', {
              className: t ? 'd-flex' : '',
              onSubmit: function (e) {
                e.preventDefault(),
                  u({ type: 'BUDGET_CHANGE', payload: s }),
                  r(!1)
              },
              children: [
                t
                  ...
                  : (0, b.jsxs)('span', { children: ['Budget : $', o] }),
                t
                  ? (0, b.jsx)('button', {
                      type: 'submit',
                      className: 'btn btn-sm btn-primary ms-3 px-3',
                      children: 'Ok',
                    })
                  : (0, b.jsx)('div', {
                      onClick: function () {
                      ...
                      type: 'button',
                      className:
                        'btn btn-primary btn-sm ms-3 px-3 budget-button',
                      children: 'Edit',
                    }),
              ],
            }),
        ...
        P = function () {
          var n = (0, e.useContext)(S),
            ...
            a = l > r ? 'alert-danger' : 'alert-success'
          return (0, b.jsx)('div', {
            className: 'alert '.concat(a),
            children: (0, b.jsxs)('span', {
              children: ['Remaining: $', r - l],
            }),
          })
        },
        z = function () {
          var n = (0, e.useContext)(S).expenses.reduce(function (e, n) {
            return e + n.cost
          }, 0)
          return (0, b.jsx)('div', {
            className: 'alert alert-primary',
            children: (0, b.jsxs)('span', { children: ['Spent so far: $', n] }),
          })
        },
        O = function (e) {
      ...
      var I = function (e, n, t) {
        ...
        U = function (n) {
          ...
          return (0, b.jsx)('form', {
            onSubmit: function (e) {
              e.preventDefault()
              var n = { name: l, cost: parseInt(i), id: I() }
              t({ type: 'ADD_EXPENSE', payload: n }), o(''), s('')
            },
            children: (0, b.jsxs)('div', {
              ...
              children: [
                (0, b.jsxs)('div', {
                  ...
                  children: [
                    (0, b.jsx)('label', { htmlFor: 'name', children: 'Name' }),
                    (0, b.jsx)('input', {
                      type: 'text',
                      required: !0,
                ...
                (0, b.jsxs)('div', {
                  className: 'col-sm mt-3',
                  children: [
                    (0, b.jsx)('label', { htmlFor: 'Cost', children: 'Cost' }),
                    (0, b.jsx)('input', {
                      value: i,
                      type: 'number',
                      min: '0',
      ...
      var G = (0, e.forwardRef)(function (n, t) {
        var r = n.color,
          l = n.size,
          a = n.title,
          o = X(n, K)
      ...
      ;(G.propTypes = {
        ...
        (G.defaultProps = { color: 'currentColor', size: '1em', title: null })
      var Z = G,
        J = ['color', 'size', 'title']
      function ee() {
        return (
      ...
      ;(te.propTypes = {
        ...
        (te.defaultProps = { color: 'currentColor', size: '1em', title: null })
      var re = te,
        le = function () {
          return (0, b.jsxs)('footer', {
            ...
            children: [
              (0, b.jsx)('div', {
                className: 'col-md-4 d-flex align-items-center ms-5',
                children: (0, b.jsx)('span', {
                  className: 'mb-3 mb-md-0 text-muted',
                  children: '\xa9 2022 Poorvansh Kavta',
                }),
              }),
              (0, b.jsxs)('ul', {
                className:
                  'nav col-md-4 me-5 justify-content-end list-unstyled d-flex',
                children: [
                  (0, b.jsx)('li', {
                    className: 'ms-3',
                    children: (0, b.jsx)('a', {
                      ...
                      children: (0, b.jsx)('h2', {
                        children: (0, b.jsx)(q, { className: 'dribbble-icon' }),
                      }),
                    }),
                  }),
                  (0, b.jsx)('li', {
                    ...
                    children: (0, b.jsx)('a', {
                      ...
                      children: (0, b.jsx)('h2', {
                        children: (0, b.jsx)(Z, { className: 'github-icon' }),
                      }),
                    }),
                  }),
                  (0, b.jsx)('li', {
                    ...
                    children: (0, b.jsx)('a', {
                      ...
                      children: (0, b.jsx)('h2', {
                        children: (0, b.jsx)(re, { className: 'twitter-icon' }),
                      }),
                    }),
                  }),
                ],
      ...
      n.createRoot(document.getElementById('root')).render(
        (0, b.jsx)(e.StrictMode, { children: (0, b.jsx)(ae, {}) })
      )
    })()
})()
//# sourceMappingURL=main.10a43592.js.map
